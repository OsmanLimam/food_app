...
export default function ProfileScreen() {
  ...
  const { favorites, getCartCount } = useStore();
      ...
      <div className="px-5 pt-2">
        <div className="bg-surface rounded-2xl p-5 flex items-center gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-lg font-bold text-text">SaviDon</h2>
            <p className="text-sm text-text-secondary">savidon@knust.edu.gh</p>
            <p className="text-xs text-text-muted mt-1">KNUST Student • Level 400</p>
          </div>
          <button className="w-9 h-9 rounded-xl bg-elevated flex items-center justify-center">
        ...
        {/* Logout */}
        <button className="w-full mt-4 bg-surface rounded-2xl p-4 flex items-center gap-3 active:bg-elevated transition-colors">
